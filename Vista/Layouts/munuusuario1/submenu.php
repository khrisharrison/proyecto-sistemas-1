      ...
      <ul class="nav nav-tabs">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu">
            ...
            <li>
              <a class="trigger right-caret nav-link" href="#">Recibos</a> 
              <ul class="dropdown-menu sub-menu">
              </ul>
            </li>
            <li>
              <a class="trigger right-caret nav-link" href="#">Facturas</a>
              <ul class="dropdown-menu sub-menu">
              </ul>
            </li>
          </ul>
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu">
            <li>
              <a class="trigger right-caret nav-link" href="#">Respaldo</a>
              <ul class="dropdown-menu sub-menu">
              </ul>
            </li>
            <li>
              <a class="trigger right-caret nav-link" href="#">Recuperación</a>
              <ul class="dropdown-menu sub-menu">
              </ul>
            </li>
            <li>
